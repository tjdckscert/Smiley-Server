...
public class FacialChangeController {
    ...
    public FacialChangeController(FacialChangeService facialChangeService) { this.facialChangeService = facialChangeService; }
    ...
    public ResponseEntity<FacialChangeImageDto> getImageFile(@PathVariable("userId") String userId, @PathVariable("date") String date) throws IOException{
    ...
    public boolean deleteImageFile(@PathVariable("userId") String userId, @PathVariable("date") String date) throws IOException {
